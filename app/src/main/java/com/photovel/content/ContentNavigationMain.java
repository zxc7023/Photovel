...
public class ContentNavigationMain extends FontActivity2 implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new ContentDetailListAdapter(myDataset, ContentNavigationMain.this);
        ...
        mCommentAdapter = new CommentAdapter(myCommentDataset, ContentNavigationMain.this);
        ...
        findViewById(R.id.btnCommentSubmit).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(getApplicationContext(), ContentNavigationMain.class);
                intent.putExtra("content_id", content_id);
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.action_update:
                        Intent intent = new Intent(ContentNavigationMain.this, ContentUpdateMain.class);
                        intent.putExtra("content_id", content_id);
                        ContentNavigationMain.this.startActivity(intent);
                        Toast.makeText(getApplicationContext(), "수정", Toast.LENGTH_SHORT).show();
                        break;
                    case R.id.action_delete:
                        AlertDialog.Builder dalert_confirm = new AlertDialog.Builder(ContentNavigationMain.this);
                    ...
                    case R.id.action_report:
                        AlertDialog.Builder walert_confirm = new AlertDialog.Builder(ContentNavigationMain.this);
